...
public class RestClient {
  ...
  public String searchFeelings(String uri,String lat,String lon) {
	String searchQuery = "{\"query\":{\"bool\":{\"filter\":{\"geo_distance\":{\"distance\":\"0.1km\",\"location\":{\"lat\":"+ lat +",\"lon\":"+ lon +"}}}}}}";
   String completeUrl = uri+"source={searchQuery}";
   System.out.println(completeUrl);
	HttpEntity<String> requestEntity = new HttpEntity<String>("", headers);
    ResponseEntity<String> responseEntity = rest.exchange(server + completeUrl, HttpMethod.GET, requestEntity, String.class,searchQuery);
    this.setStatus(responseEntity.getStatusCode());
    return responseEntity.getBody();
  }
